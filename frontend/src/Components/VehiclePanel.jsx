...
const VehiclePanel = (props) => {
      ...
      if (props.selectedLocations.pickup && props.selectedLocations.destination) {
        ...
        try {
          ...
          if (data.estimatedFare) {
            ...
            setFares(nextFares);
            try {
              localStorage.setItem('fareBase', String(data.estimatedFare));
  ...
  return (
    ...
    <div onClick={()=>{
      ...
      try { 
        localStorage.setItem('selectedVehicleType', 'bike'); 
        localStorage.setItem('selectedFare', String(fares.bike)); 
    ...
    <div onClick={()=>{
      // Store selected vehicle and location data
      try { 
        localStorage.setItem('selectedVehicleType', 'auto'); 
        localStorage.setItem('selectedFare', String(fares.auto)); 
        // Store pickup/dropoff addresses and coordinates
        if (props.selectedLocations.pickup) {
          localStorage.setItem('pickupAddress', props.selectedLocations.pickup.text || 'Pickup Location');
          localStorage.setItem('pickupLat', String(props.selectedLocations.pickup.lat));
